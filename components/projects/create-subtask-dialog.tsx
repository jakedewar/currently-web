...
export function CreateSubtaskDialog({ taskId, projectId, onSubtaskCreated }: CreateSubtaskDialogProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true)
    try {
      const response = await fetch(`/api/projects/${projectId}/work-items/${taskId}/subtasks`, {
        method: 'POST',
        headers: {
