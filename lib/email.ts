        ...
        <body>
          <div class="email-wrapper">
            <div class="container">
              ...
              <div class="footer">
                <p class="footer-text">
                  This invitation was sent by <a href="https://currently.app" class="footer-link">Currently</a>.
                </p>
                <p class="footer-text">
        ...
        <body>
          <div class="email-wrapper">
            <div class="container">
              ...
              <div class="footer">
                <p class="footer-text">
                  This reminder was sent by <a href="https://currently.app" class="footer-link">Currently</a>.
                </p>
                <p class="footer-text">
                  Questions? Contact your organization administrator or reply to this email.
                </p>
